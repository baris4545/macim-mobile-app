  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Oyuncu İlanı</Text>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.heroTop}>
            ...
            <View style={styles.heroTag}>
              ...
              <Text style={styles.heroTagText}>Aktif ilan</Text>
            </View>
          </View>

          <Text style={styles.heroTitle}>{position}</Text>
          <Text style={styles.heroSub}>Oyuncu aranıyor</Text>

          <View style={styles.pills}>
            <Pill icon="location-outline" text={city} />
            <Pill icon="person-outline" text={name} />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <InfoRow icon="football-outline" label="Pozisyon" value={position} />
            <InfoRow icon="location-outline" label="Şehir" value={city} />
            <InfoRow icon="person-outline" label="İlan Sahibi" value={name} />
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  heroTitle: { color: "white", fontSize: 22, fontWeight: "900", marginTop: 14 },
  heroSub: { color: "#9CA3AF", marginTop: 6, fontWeight: "700" },
  ...
  infoValue: { color: "white", fontWeight: "900", fontSize: 12, maxWidth: "45%" },
